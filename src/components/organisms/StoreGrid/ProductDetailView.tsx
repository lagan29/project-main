...
import type { StoreGridProduct } from "./types";

type ProductDetailViewProps = {
  product: StoreGridProduct;
  moreProducts: StoreGridProduct[];
};
  ...
  return (
    <div className="mx-auto px-6 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-20">
        ...
        <div>
          <h1 className="text-3xl md:text-4xl font-serif text-text-300">
            {product.title}
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Button
              ...
              onClick={() => {
                ...
                if (!selectedSize) setSelectedSize("M");
      ...
      {moreProducts.length > 0 && (
        <section>
          <h2 className="text-2xl font-serif text-text-300 mb-8">
            More products
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {moreProducts.map((p) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="font-medium text-text-300 group-hover:text-text-200">
                    {p.title}
                  </h3>
